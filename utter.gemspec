...
Gem::Specification.new do |spec|
  ...
  spec.description   = %q{Utter provides a standard API to allow any class that
                          includes the Utter module to emit events. Utter
                          abstracts away event queueing and propagation so you
